...
class Land(pygame.sprite.Sprite):
    def __init__(self, level, *groups):
        ...
        self.forest_thresh = {"Grassland" : 400, "Grass and Trees" :200, "Scrub": 600, "Light Woods": 400, "Medium Woods": 400,"Oasis":800,"Cactus":800}
        self.forest_conv = {"Grassland" : 2, "Grass and Trees" : 3, "Scrub": 1, "Light Woods": 4, "Medium Woods": 5,"Oasis":3,"Cactus":16}
        
        #deserts
        self.desert_level = 0
        self.dp = random.randrange(300)#random progress toward state change
        self.desert_prone = False
        self.desert_thresh = { "Grassland" : 400, "Grass and Trees" : 600, "Scrub": 200, "Water": 800, "Oasis": 600, "Cactus":700}
        self.desert_conv = { "Grassland" : 7, "Grass and Trees" : 1, "Scrub": 8, "Water": 16, "Oasis": 7, "Cactus":8}
        
        
        
        #type
        self.flavor_saver = ["Void", "Grassland", "Grass and Trees", "Light Woods", "Medium Woods", "Dense Woods", "Hills", "Scrub", "Dunes",\
            "Gravel", "Mountain", "Extinct Volcano", "Active Volcano", "Water", "Ocean", "Whirlpool","Oasis","Cactus"]
...
class Landmark(pygame.sprite.Sprite):
    def __init__(self, level, *groups):
        ...
        self.flavor = "Pyramid"
        self.flavnum = 0
        self.flavor_saver = ["Pyramid","Henge", "Peak", "FoY"]
        self.tertype = {0:8, 1:1, 2:10, 3:1}
        self.points = 0
        self.revealed = False
    ...
    def spawn(self,x,y):
        ...
        self.scrny = y
        self.rect = pygame.rect.Rect((x * self.level.tilex, y * self.level.tiley), self.image.get_size())
        mylands = [self.level.mymap[self.mapx][self.mapy],self.level.mymap[self.mapx+1][self.mapy],self.level.mymap[self.mapx][self.mapy+1],self.level.mymap[self.mapx+1][self.mapy+1]]
        for land in mylands:
            land.set_type(self.tertype[self.flavnum])
            
            land.get_image()
            self.level.player1.unpassable.remove(land)
